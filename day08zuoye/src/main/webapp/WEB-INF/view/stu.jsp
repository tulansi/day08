...
<body class="gray-bg">
	<div class="panel-body">
        ...
        <div class="row">
			  ...
			  <div class="col-lg-2">
				<div class="input-group">
			      <span class="input-group-addon">生日名 </span>
					...
					<form id="form_user" method="post" action="reserveStu.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								...
								<td>学生性别：</td>
								<td><input type="radio" id="sSex1" value="男" name="sSex"
									 aria-required="true" required/>男</td>
								<td><input type="radio" id="sSex2" value="女" name="sSex"
									 aria-required="true" required/>女</td>
							</tr>
							<tr>
								<td>学生爱好：</td>
								<td><input type="checkbox" id="sHobby1" value="干练" name="sHobby"/>干练
								<input type="checkbox" id="sHobby2" value="善良" name="sHobby"/>善良
								<input type="checkbox" id="sHobby3" value="耐心" name="sHobby"/>耐心
								<input type="checkbox" id="sHobby4" value="能干" name="sHobby"/>能干
								</td>
